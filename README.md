...
[The Lyric Mood Classification Pipeline](#lyric-mood-classification-pipeline)<br/>
...
For a detailed discussion of our results and review of available literature, please take a look at our paper: [lyric-mood-classification-with-deep-learning.pdf](https://github.com/workmanjack/lyric-mood-classification/blob/master/report/lyric-mood-classification-with-deep-learning.pdf)
...
Additionally, the lyrics2vec embeddings and associated data are saved in logs/tf/lyrics2vec_expanded with directories lyrics2vec_V-10000_Wt-1 where 10000 is your vocab size and Wt-1 is your word tokenizer (see word_tokenizers dict in mood_classification.py).
...
Note that you will first need to scrape, index, and label the lyrics (see: [Project Procedure & Walkthrough](#project-procedure-and-walkthrough)).
